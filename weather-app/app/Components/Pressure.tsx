...
const Pressure = () => {
  ...
  const getPressureDescription = (pressure: number) => {
    if (pressure < 1000) return "Very Low: Risk of flooding.";
    if (pressure < 1015) return "Low pressure: Expect weather changes.";
    if (pressure < 1025) return "Normal pressure: Stable weather.";
    if (pressure < 1040) return "High pressure: Clear skies.";
